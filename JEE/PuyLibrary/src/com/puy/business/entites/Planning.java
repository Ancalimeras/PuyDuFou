...
public class Planning implements Serializable {
    ...
    @JoinColumn(name = "id_spectacle", referencedColumnName = "id_spectacle")
    ...
    public Planning(Integer idPlanning, String jourSemaine, Date heureDebut) {
        this.idPlanning = idPlanning;
    ...
    public void setIdSpectacle(Spectacle idSpectacle) {
